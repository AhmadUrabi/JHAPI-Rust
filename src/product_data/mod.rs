...
pub async fn get_product(
    ...
    for row_result in rows {
        ...
        products.push(Product {
            ...
            QTY_STORE_10: row.get(28)?,
            QTY_STORE_11: row.get(29)?,
            QTY_STORE_12: row.get(30)?,
            QTY_STORE_19: row.get(31)?,
            QTY_STORE_21: row.get(32)?,
            QTY_STORE_23: row.get(33)?,
            QTY_STORE_31: row.get(34)?,
            QTY_STORE_32: row.get(35)?,
            QTY_STORE_33: row.get(36)?,
            QTY_STORE_34: row.get(37)?,
            QTY_STORE_35: row.get(38)?,
            SALE_PRICE_NOTAX_STORE_01: row.get(39)?,
            SALE_PRICE_NOTAX_STORE_02: row.get(40)?,
            SALE_PRICE_NOTAX_STORE_05: row.get(41)?,
            SALE_PRICE_NOTAX_STORE_06: row.get(42)?,
            SALE_PRICE_NOTAX_STORE_08: row.get(43)?,
            SALE_PRICE_NOTAX_STORE_07: row.get(44)?,
            SALE_PRICE_NOTAX_STORE_31: row.get(45)?,
            SALE_PRICE_NOTAX_STORE_32: row.get(46)?,
            SALE_PRICE_NOTAX_STORE_33: row.get(47)?,
            SALE_PRICE_NOTAX_STORE_34: row.get(48)?,
            SALE_PRICE_NOTAX_STORE_35: row.get(49)?,
            FIRST_DISC_PER_STORE_01: row.get(50)?,
            FIRST_DISC_PER_STORE_02: row.get(51)?,
            FIRST_DISC_PER_STORE_05: row.get(52)?,
            FIRST_DISC_PER_STORE_06: row.get(53)?,
            FIRST_DISC_PER_STORE_07: row.get(54)?,
            FIRST_DISC_PER_STORE_08: row.get(55)?,
            FIRST_DISC_PER_STORE_31: row.get(56)?,
            FIRST_DISC_PER_STORE_32: row.get(57)?,
            FIRST_DISC_PER_STORE_33: row.get(58)?,
            FIRST_DISC_PER_STORE_34: row.get(59)?,
            FIRST_DISC_PER_STORE_35: row.get(60)?,
            SECOND_DISC_PER_STORE_01: row.get(61)?,
            SECOND_DISC_PER_STORE_02: row.get(62)?,
            SECOND_DISC_PER_STORE_05: row.get(63)?,
            SECOND_DISC_PER_STORE_06: row.get(64)?,
            SECOND_DISC_PER_STORE_07: row.get(65)?,
            SECOND_DISC_PER_STORE_08: row.get(66)?,
            SECOND_DISC_PER_STORE_31: row.get(67)?,
            SECOND_DISC_PER_STORE_32: row.get(68)?,
            SECOND_DISC_PER_STORE_33: row.get(69)?,
            SECOND_DISC_PER_STORE_34: row.get(70)?,
            SECOND_DISC_PER_STORE_35: row.get(71)?,
