...
pub async fn get_product(
    ...
    fn get_value(store_ids: &HashSet<String>, row: &Row, store_id: &str, column_name: &str) -> Option<String> {
    ...
    for row_result in rows {
        ...
        products.push(Product {
            ...
            T_AVE_COST: if show_cost {row.get("T_AVE_COST").ok()} else {None},
        });
    }
